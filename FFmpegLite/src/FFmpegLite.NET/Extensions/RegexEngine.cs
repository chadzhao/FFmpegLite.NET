...
namespace FFmpegLite.NET
{
    ...
    internal static class RegexEngine
    {
        ...
        internal static void TestVideo(string data, FFmpegTask task)
        {
            ...
            if (task.MetaData == null) task.MetaData = new MetaData();

            if (task.MetaData.VideoData == null)
            {
                task.MetaData.VideoData = new MetaData.Video
                {
        ...
        internal static void TestAudio(string data, FFmpegTask task)
        {
            ...
            if(task.MetaData.AudioData == null)
            {
                task.MetaData.AudioData = new MetaData.Audio
                {
